  ...
  return (
    <div className="mt-8">
      <div className="flex justify-between items-center mb-4">
        ...
        {!isKorean && (
          <Button onClick={onTranslate} disabled={translating || !!translation}>
            {translation ? "번역됨" : translating ? "번역중..." : "한국어로 번역"}
          </Button>
        )}
      </div>
      <div className="space-y-4">
        {(translation || translating) && !isKorean && (
        ...
        <div className="p-4 rounded-md bg-gray-50 dark:bg-gray-800/50">
          ...
          <p className={`dark:text-gray-200 leading-relaxed ${translation ? "text-gray-600 dark:text-gray-400" : ""}`}>
            {combinedText}
          </p>
        </div>
      </div>
